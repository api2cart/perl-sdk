...
#my $order_info_rounding_precision = undef; # replace NULL with a proper value
#my $order_info_result = $api->order_info(id => $order_info_id, order_id => $order_info_order_id, store_id => $order_info_store_id, params => $order_info_params, response_fields => $order_info_response_fields, exclude => $order_info_exclude, enable_cache => $order_info_enable_cache, use_latest_api_version => $order_info_use_latest_api_version, rounding_precision => $order_info_rounding_precision);
