...
#
# uncomment below and update the test
#my $product_count_sku = undef; # replace NULL with a proper value
...
#my $product_count_manufacturer_id = undef; # replace NULL with a proper value
...
#my $product_list_manufacturer_id = undef; # replace NULL with a proper value
...
#my $product_list_result = $api->product_list(start => $product_list_start, count => $product_list_count, page_cursor => $product_list_page_cursor, product_ids => $product_list_product_ids, since_id => $product_list_since_id, categories_ids => $product_list_categories_ids, category_id => $product_list_category_id, store_id => $product_list_store_id, lang_id => $product_list_lang_id, currency_id => $product_list_currency_id, avail_view => $product_list_avail_view, avail_sale => $product_list_avail_sale, created_from => $product_list_created_from, created_to => $product_list_created_to, modified_from => $product_list_modified_from, modified_to => $product_list_modified_to, sku => $product_list_sku, brand_name => $product_list_brand_name, product_attributes => $product_list_product_attributes, manufacturer_id => $product_list_manufacturer_id, status => $product_list_status, type => $product_list_type, visible => $product_list_visible, find_value => $product_list_find_value, find_where => $product_list_find_where, return_global => $product_list_return_global, params => $product_list_params, response_fields => $product_list_response_fields, exclude => $product_list_exclude, sort_by => $product_list_sort_by, sort_direction => $product_list_sort_direction, report_request_id => $product_list_report_request_id, disable_cache => $product_list_disable_cache, disable_report_cache => $product_list_disable_report_cache, use_latest_api_version => $product_list_use_latest_api_version, product_type => $product_list_product_type);
