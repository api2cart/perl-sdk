...
# @param string $exclude Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'order_find' } = {
        summary => 'order.find',
        params => $params,
...
sub order_find {
    ...
    # parse inputs
    my $_resource_path = '/order.find.json';
    ...
    my $_response_object = $self->{api_client}->deserialize('OrderFind200Response', $response);
    return $_response_object;
}
