...
#
package WWW::OpenAPIClient::Object::CartStoreInfo;
...
__PACKAGE__->method_documentation({
    ...
    'store_languages' => {
        datatype => 'ARRAY[Language]',
        base_name => 'store_languages',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'store_currencies' => {
        datatype => 'ARRAY[Currency]',
        base_name => 'store_currencies',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'prices_include_tax' => {
        datatype => 'boolean',
        base_name => 'prices_include_tax',
        description => '',
        format => '',
        read_only => '',
            },
    'carrier_info' => {
        datatype => 'ARRAY[Carrier]',
        base_name => 'carrier_info',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'default_warehouse_id' => {
        datatype => 'string',
        base_name => 'default_warehouse_id',
        description => '',
        format => '',
        read_only => '',
            },
    'channels' => {
        datatype => 'ARRAY[CartChannel]',
        base_name => 'channels',
        description => '',
        format => '',
        read_only => '',
