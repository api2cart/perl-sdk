...
__PACKAGE__->method_documentation({
    ...
    'group_items' => {
        datatype => 'ARRAY[ProductGroupItem]',
        base_name => 'group_items',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'tier_price' => {
        datatype => 'ARRAY[ProductTierPrice]',
        base_name => 'tier_price',
        description => '',
        format => '',
        read_only => '',
            },
    'group_price' => {
        datatype => 'ARRAY[ProductGroupPrice]',
        base_name => 'group_price',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'product_options' => {
        datatype => 'ARRAY[ProductOption]',
        base_name => 'product_options',
        description => '',
        format => '',
        read_only => '',
            },
