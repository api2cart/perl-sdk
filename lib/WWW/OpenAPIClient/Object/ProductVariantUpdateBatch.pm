...
#
package WWW::OpenAPIClient::Object::ProductVariantUpdateBatch;
...
__PACKAGE__->method_documentation({
    ...
    'payload' => {
        datatype => 'ARRAY[ProductVariantUpdateBatchPayloadInner]',
        base_name => 'payload',
        description => 'Contains an array of product objects. The list of properties may vary depending on the specific platform.',
        format => '',
        read_only => '',
            },
});
