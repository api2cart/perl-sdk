...
#
package WWW::OpenAPIClient::Object::ProductOptionAdd;
...
__PACKAGE__->method_documentation({
    ...
    'default_option_value' => {
        datatype => 'string',
        base_name => 'default_option_value',
    ...
    'values' => {
        datatype => 'ARRAY[ProductOptionAddValuesInner]',
        base_name => 'values',
        description => 'An array of option values.&lt;/b&gt;',
        format => '',
        read_only => '',
            },
    'clear_cache' => {
