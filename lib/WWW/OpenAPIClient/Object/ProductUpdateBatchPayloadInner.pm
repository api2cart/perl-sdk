...
#
package WWW::OpenAPIClient::Object::ProductUpdateBatchPayloadInner;
...
__PACKAGE__->method_documentation({
    ...
    'images' => {
        datatype => 'ARRAY[ProductUpdateBatchPayloadInnerImagesInner]',
        base_name => 'images',
        description => 'Property &#39;nested_items_update_behaviour&#39; does not apply. Specified items will be added to existing product images',
        format => '',
        read_only => '',
            },
