...
#
package WWW::OpenAPIClient::Object::OrderAddOrderItemInner;
...
__PACKAGE__->method_documentation({
    ...
    'order_item_weight' => {
        datatype => 'double',
        base_name => 'order_item_weight',
        description => 'Defines orders specified by order item weight',
        format => '',
        read_only => '',
            },
    'order_item_variant_id' => {
        datatype => 'string',
        base_name => 'order_item_variant_id',
    ...
    'order_item_tax_class' => {
        datatype => 'string',
        base_name => 'order_item_tax_class',
        description => 'Id of the tax class of product.',
        format => '',
        read_only => '',
            },
    ...
    'order_item_allow_refund_items_separately' => {
        datatype => 'boolean',
        base_name => 'order_item_allow_refund_items_separately',
    ...
    'order_item_allow_ship_items_separately' => {
        datatype => 'boolean',
        base_name => 'order_item_allow_ship_items_separately',
    ...
    'order_item_property' => {
        datatype => 'ARRAY[OrderAddOrderItemInnerOrderItemPropertyInner]',
        base_name => 'order_item_property',
        description => '',
        format => '',
        read_only => '',
            },
