...
__PACKAGE__->method_documentation({
    ...
    'processing_profile_id' => {
        datatype => 'int',
        base_name => 'processing_profile_id',
        description => 'The numeric ID of the processing profile (readiness state) for physical products in Etsy. You can find possible values in the \&quot;cart.info\&quot; API method response, in the field processing_profiles[]-&gt;readiness_state_id.',
        format => '',
        read_only => '',
            },
    'when_made' => {
