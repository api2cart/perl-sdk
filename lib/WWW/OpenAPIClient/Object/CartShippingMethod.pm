...
#
package WWW::OpenAPIClient::Object::CartShippingMethod;
...
__PACKAGE__->method_documentation({
    ...
    'min_order_amount' => {
        datatype => 'string',
        base_name => 'min_order_amount',
        description => '',
        format => '',
        read_only => '',
            },
    'rates' => {
        datatype => 'ARRAY[CartShippingMethodRate]',
        base_name => 'rates',
        description => '',
        format => '',
        read_only => '',
