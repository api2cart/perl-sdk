...
#
package WWW::OpenAPIClient::Object::OrderPreestimateShippingListOrderItemInner;
...
__PACKAGE__->method_documentation({
    ...
    'order_item_option' => {
        datatype => 'ARRAY[OrderPreestimateShippingListOrderItemInnerOrderItemOptionInner]',
