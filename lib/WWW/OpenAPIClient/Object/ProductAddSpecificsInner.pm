...
#
package WWW::OpenAPIClient::Object::ProductAddSpecificsInner;
...
__PACKAGE__->method_documentation({
    ...
    'group_products_details' => {
        datatype => 'ARRAY[ProductAddSpecificsInnerGroupProductsDetailsInner]',
        base_name => 'group_products_details',
        description => '',
        format => '',
        read_only => '',
            },
    'booking_details' => {
        datatype => 'ProductAddSpecificsInnerBookingDetails',
        base_name => 'booking_details',
        description => '',
        format => '',
        read_only => '',
            },
