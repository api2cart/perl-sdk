...
#
package WWW::OpenAPIClient::Object::OrderReturnAdd;
...
__PACKAGE__->method_documentation({
    ...
    'return_status_id' => {
        datatype => 'string',
        base_name => 'return_status_id',
        description => 'Defines return request status',
        format => '',
        read_only => '',
            },
    'return_action_id' => {
        datatype => 'string',
        base_name => 'return_action_id',
        description => 'Defines return request action',
        format => '',
        read_only => '',
            },
    'return_reason_id' => {
        datatype => 'string',
        base_name => 'return_reason_id',
        description => 'Defines return request reason',
        format => '',
        read_only => '',
            },
    'return_reason' => {
        datatype => 'string',
        base_name => 'return_reason',
        description => 'Defines return request reason',
        format => '',
        read_only => '',
            },
    ...
    'staff_note' => {
        datatype => 'string',
        base_name => 'staff_note',
        description => 'Specifies staff note',
        format => '',
        read_only => '',
            },
    'comment' => {
        datatype => 'string',
        base_name => 'comment',
        description => 'Specifies return comment',
        format => '',
        read_only => '',
            },
    'send_notifications' => {
    ...
    'reject_reason' => {
        ...
        description => 'Defines return reject reason',
        format => '',
        read_only => '',
            },
    'order_products' => {
        datatype => 'ARRAY[OrderReturnAddOrderProductsInner]',
