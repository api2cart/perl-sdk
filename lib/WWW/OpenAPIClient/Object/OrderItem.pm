...
#
package WWW::OpenAPIClient::Object::OrderItem;
...
__PACKAGE__->method_documentation({
    ...
    'tax_value_after_discount' => {
        datatype => 'double',
        base_name => 'tax_value_after_discount',
        description => '',
        format => '',
        read_only => '',
            },
    'options' => {
        datatype => 'ARRAY[OrderItemOption]',
        base_name => 'options',
        description => '',
        format => '',
        read_only => '',
    ...
    'parent_order_product_id' => {
        datatype => 'string',
        base_name => 'parent_order_product_id',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'tax_percent' => 'double',
    'tax_value' => 'double',
    'tax_value_after_discount' => 'double',
