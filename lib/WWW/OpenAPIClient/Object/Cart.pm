...
#
package WWW::OpenAPIClient::Object::Cart;
...
__PACKAGE__->method_documentation({
    ...
    'default_rounding_precision' => {
        datatype => 'int',
        base_name => 'default_rounding_precision',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'stores_info' => {
        datatype => 'ARRAY[CartStoreInfo]',
        base_name => 'stores_info',
        description => '',
        format => '',
        read_only => '',
            },
    'warehouses' => {
        datatype => 'ARRAY[CartWarehouse]',
    ...
    'shipping_zones' => {
        datatype => 'ARRAY[CartShippingZone]',
        base_name => 'shipping_zones',
        description => '',
        format => '',
        read_only => '',
            },
