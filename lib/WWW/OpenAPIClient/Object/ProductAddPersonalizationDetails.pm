...
#
package WWW::OpenAPIClient::Object::ProductAddPersonalizationDetails;
...
__PACKAGE__->method_documentation({
    ...
    'personalization_is_required' => {
        datatype => 'boolean',
        base_name => 'personalization_is_required',
        description => '',
        format => '',
        read_only => '',
            },
    'personalization_char_count_max' => {
        datatype => 'int',
        base_name => 'personalization_char_count_max',
        description => '',
        format => '',
        read_only => '',
            },
    'personalization_instructions' => {
        datatype => 'string',
        base_name => 'personalization_instructions',
        description => '',
        format => '',
        read_only => '',
            },
